 ...
 */
public class TimePickerFragmentOpenS extends DialogFragment implements TimePickerDialog.OnTimeSetListener{
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute){
        ...
        TextView tv = (TextView) getActivity().findViewById(R.id.horaOpenS);
